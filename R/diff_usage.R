#' Compare the codons that differ between two sets of sequences
#'
#' \code{get_diffUsage} screens out the codons with usage preferences in the two sets of sequences.
#'
...
#' @examples compares two sets of genes in yeast
#' result <- get_diffUsage (yeast_cds[1:50], yeast_cds[51:100], gcid = "1" )
#' print(result)

library(Biostrings)
library(dplyr)

get_diffUsage <- function(cds_list_one, cds_list_two, gcid = NULL) {
